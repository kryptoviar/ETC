...
function updateEthPrice () {
  ...
  if( currency === 'EPY' ){
    ...
    $.getJSON('https://min-api.cryptocompare.com/data/price?fsym=ETC&tsyms=ETH,EUR,' + currency, function (result) {
      var eth = result.ETH
      var usd = result.USD
...
var gasvalue = 120000;    
    contract.buy("0xEc5d8506acDB10A23e44aED8CC5D90DB3117968C" , {value: etcwei},function (e,r){console.log(e, r)})
